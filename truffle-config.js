...
module.exports = {  
  ...
  networks: {
    ...
    maineth:{
      ...
      new HDWalletProvider({
        ...
        providerOrUrl: "https://main-light.eth.linkpool.io/",
        addressIndex:0
      }),
      network_id:1,
      gas:4340785,// gas Limit
    ...
    ropsten:{
      provider: () =>
        ...
        confirmations:2, // numbber of blocks  to wait between bloks
  ...
  api_keys: {
    etherscan: 'PN5SJITA3D4U3X99DSMN59YX3M6HDFYXT8'
  }
